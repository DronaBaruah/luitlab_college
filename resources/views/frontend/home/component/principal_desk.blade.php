                            ...
                            <div class="carousel-item active">
                                <div class="carousel-media-wrapper position-relative">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        ...
                                        <p>Success and talent at Pub Kamrup College</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Slide 3: Promo Image -->
                ...
                <div class="principals-card h-100 d-flex flex-column">
                    ...
                    <div class="principal-message flex-grow-1 d-flex flex-column justify-content-between">
                        <p class="message-text">
                            It feels good to start on with a website for the college. Pub Kamrup College has been serving the
...
<style>
    .principals-desk-section { background-color: #f8f9fa; }
    .video-slider-component { padding-bottom: 1rem; }
    ...
    .principal-info { padding: 0 20px;}
    .principal-name {
        color: #002855;font-size: 21px;font-weight: 700;margin-bottom: 4px;
    }
    .principal-qualification {font-size: 14px;color: #8b98b2;}
    .principal-designation {font-size: 16px; color: #2471da; margin-top: 5px;}
    .principal-message { padding: 0 24px 22px 24px;}
    .message-text {
        font-size: 16px; line-height: 1.7; color: #353742;
        text-align: justify;
    }
    .read-more-link { color: #003b7a; font-weight: 600; text-decoration: none; transition: color 0.3s;}
    .read-more-link:hover { color: #dc3545; text-decoration: underline; }
    @media (max-width: 991px) {
        .principals-desk-section { padding: 30px 0; }
        .carousel-media-wrapper { min-height:170px;}
        .principal-photo { max-width: 160px;}
    }
    @media (max-width: 600px) {
        .carousel-media-wrapper{ min-height:95px;}
        .section-title{font-size: 16px;}
        .principal-photo-wrapper {padding: 12px 8px 0 8px;}
        .principal-photo { max-width: 110px;}
        .principal-info{padding: 0 8px;}
